...
// general images
  ...
  // static String motoShop = "$bagImagesPath/moto_shop.png";
  ...
  // Banners
  static String banner1 = "$bannersImagesPath/1.jpg";
  static String banner2 = "$bannersImagesPath/2.png";
  static String banner3 = "$bannersImagesPath/3.png";
